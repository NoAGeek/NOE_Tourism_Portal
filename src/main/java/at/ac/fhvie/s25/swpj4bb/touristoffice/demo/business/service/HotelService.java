package at.ac.fhvie.s25.swpj4bb.touristoffice.demo.business.service;

import at.ac.fhvie.s25.swpj4bb.touristoffice.demo.business.constants.Category;
import at.ac.fhvie.s25.swpj4bb.touristoffice.demo.business.converter.CategoryConverter;
import at.ac.fhvie.s25.swpj4bb.touristoffice.demo.business.repository.HotelRepository;
...
public class HotelService {
   ...
   */
  public Hotel findById(final Long id) {  // Ändere int zu Long
    return hotelRepository.findById(id)
        .orElseThrow(() -> new RuntimeException("Hotel mit ID " + id + " nicht gefunden"));
  }
